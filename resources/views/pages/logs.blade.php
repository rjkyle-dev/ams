<x-app-layout>
        ...
        <div class="flex gap-3">
           <a href="{{ route('logs.pdf') }}" class="bg-violet-600 hover:bg-violet-700 text-white rounded-md px-5 text-2xl flex p-3 items-center">
            ...
            <button x-data="" x-on:click="$dispatch()" 
                class="bg-red-600 hover:bg-red-700 text-white rounded-md px-5 text-2xl flex p-3 items-center">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                    stroke="currentColor" class="size-9">
                    <path stroke-linecap="round" stroke-linejoin="round"
        ...
        <div class="mt-8">
            <div class="flex justify-between items-center mb-4">
                ...
                <div class="flex gap-2">
                    <button x-data="" x-on:click="$dispatch('open-modal', 'confirm-clear-fines')" 
    ...
    <x-modal name="confirm-clear-fines" focusable maxWidth="md">
        <form method="POST" action="{{ route('logs.clear-fines') }}" class="p-6">
            @csrf
            <h2 class="text-lg font-medium text-gray-900">
                Are you sure you want to clear all fines?
            </h2>

            <p class="mt-3 text-sm text-gray-600">
                This action will permanently delete all fine records. This action cannot be undone.
            </p>
