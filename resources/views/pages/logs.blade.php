<x-app-layout>
    ...
    {{-- Action buttons --}}
    <div class="bg-white mb-4 py-4 px-2 rounded-md">
        <div class="flex gap-3">
            <button class="bg-violet-600 hover:bg-violet-700 text-white rounded-md px-5 text-2xl flex p-3 items-center">
    ...
    <div class="bg-white p-3">
                ...
                <div class="flex items-center py-3">
                    ...
                    <ul class="space-y-2 text-sm" aria-labelledby="dropdownDefault">
                        ...
                        <li class="flex items-center">
                            ...
                            <label for="{{$program}}" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-100">
                                {{$program}}
                            </label>
                        </li>
                        @endforeach
                    ...
                    <ul class="space-y-2 text-sm" aria-labelledby="dropdownDefault">
                        ...
                        <li class="flex items-center">
                            ...
                            <label for="{{$key}}" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-100">
                                {{$value}}
                            </label>
                        </li>
                        @endforeach
                    ...
                    <ul class="space-y-2 text-sm" aria-labelledby="dropdownDefault">
                        ...
                        @foreach (['A', 'B', 'C', 'D', 'E', 'F', 'G', 'H'] as $set)
                            <li class="flex items-center">
                                ...
                                <label for="{{ $set }}" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-100">
                                    {{ $set }}
                                </label>
                            </li>
                        @endforeach
                    ...
                    <form class="max-w-md w-full">   
                        ...
                        <div class="relative">
                            ...
                            <div class="flex items-center">
                                <input type="search" id="default-search" class="block w-full p-4 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500" placeholder="Student name, Student ID, ..." required />
                                
                                {{-- NOTE: Remove button if Live Search is implemented --}}
                                <button type="submit" class="inline-flex items-center py-4 px-3 ms-2 text-sm font-semibold text-gray-950 bg-yellow-400 rounded-lg hover:bg-yellow-500 focus:ring-4 focus:outline-none focus:ring-blue-300">
        ...
        <div class="flex justfiy-start">
            <span id="badge-dismiss-default" class="inline-flex items-center px-2 py-1 me-2 text-sm font-semibold text-gray-950 bg-yellow-500 rounded-xl">
                ...
                <button type="button" class="inline-flex items-center p-1 ms-2 text-sm text-blue-400 bg-transparent rounded-xs hover:bg-blue-200 hover:text-blue-900 dark:hover:bg-blue-800 dark:hover:text-blue-300" data-dismiss-target="#badge-dismiss-default" aria-label="Remove">
                    <svg class="w-2 h-2 text-gray-950" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14">
