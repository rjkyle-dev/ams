            ...
            <header class="absolute inset-x-0 top-0 z-50">
              <nav class="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
                <div class="flex lg:flex-1 items-center gap-2">
                  ...
                  <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">ICSA AMS</span>
                ...
                <div class="flex lg:flex-1 lg:justify-end">
                  @if (Route::has('login'))
                    <div class="flex space-x-4">
                      @auth
                        <a href="{{ url('/dashboard') }}" class="focus:outline-none text-gray-950 bg-yellow-400 hover:bg-yellow-500 focus:ring-4 focus:ring-yellow-300 font-semibold rounded-lg text-base px-5 py-2.5 me-2 mb-2 transition">
                          Dashboard
                        </a>
                      @else
                        <a href="{{ route('login') }}" class="rounded-md px-4 py-2 text-white font-semibold bg-violet-600 hover:bg-violet-500 focus:ring-2 focus:ring-indigo-300 transition">
                          Log in
                        <a href="{{ route('login') }}" class="focus:outline-none text-gray-950 bg-yellow-400 hover:bg-yellow-500 focus:ring-4 focus:ring-yellow-300 font-semibold rounded-lg text-base px-5 py-2.5 me-2 mb-2 transition">
                        ...
                        @if (Route::has('register'))
                          <a href="{{ route('admin.code') }}" class="text-gray-950 bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 font-semibold rounded-lg text-base px-5 py-2.5 me-2 mb-2 transition">
                            <div class="flex gap-1">
                              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6">
...
{{-- <div class="flex justify-end absolute right-[130px] -top-[90px] w-[30rem] h-auto">
  <img src="{{ asset('images/logos/fox.png') }}" class="w-full h-auto" alt="IC FOX">
            ...
            <div class="relative isolate px-6 pt-14 lg:px-8">
              <div class="mx-auto max-w-4xl py-20 sm:py-26 lg:py-30 text-center">
        ...
        <div class="py-24 sm:py-32">
          <div class="mx-auto max-w-7xl px-6 lg:px-8">
            <h2 class="text-6xl text-center font-semibold tracking-tight text-pretty text-gray-100">Features and Benefits</h2>
          ...
          <div class="w-full max-w-screen-xl mx-auto p-4 md:py-8">
              <div class="sm:flex sm:items-center sm:justify-between">
                  <a href="#" class="flex items-center mb-4 sm:mb-0 space-x-3 rtl:space-x-reverse">
                      <img class="h-16 w-auto" src="{{asset('images/logos/fox.png')}}" class="h-8" alt="Flowbite Logo" />
                      <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">ICSA AMS</span>
                  </a>
              ...
              <span class="block text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2025 <a href="#" class="hover:underline">DNSC Codex</a>. All Rights Reserved.</span>
          </div>
        </footer>
        ...
        <script>
          var imagePaths = {
              jasper: "{{ asset('images/devs/jasper.jpg') }}",
              don: "{{ asset('images/devs/don.png') }}",
              panzer: "{{ asset('images/devs/panzer.jpg') }}",
              dejure: "{{ asset('images/devs/dejure.jpg') }}",
              kyle: "{{ asset('images/devs/kyle.png') }}",
              rhose: "{{ asset('images/devs/rhose.jpg') }}",
          };
